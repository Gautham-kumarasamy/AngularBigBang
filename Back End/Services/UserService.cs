...
*/
       ...
       /* public async Task<User> UpdateUser(int id, UserRegisterDTO userupdate)
        {
           *//* var users = await _userRepo.GetAll();
            User myUser = users.SingleOrDefault(u => u.UserName == user.UserName);*/
               ...
               /* myUser.Name = user.Name;
                ...
                var newUser =await _userRepo.Update(id,userupdate);
                if (newUser != null)
                {
                    return newUser;
                }
...
*/
        ...
        {
            var oldUser = await _userRepo.Delete(username);
            if (oldUser != null)
                return "deleted";
            return null;
        }
